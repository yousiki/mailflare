...
export default function AccountsPage() {
	...
	return <div className="space-y-6">
		<div className="flex items-center justify-between gap-4"><div><h1 className="text-3xl font-medium text-neutral-900">Accounts</h1><p className="mt-2 text-sm text-neutral-500">Manage additional accounts and their inboxes in this self-hosted deployment.</p></div><Button onClick={() => setCreateOpen(true)}><Plus className="h-4 w-4" />New account</Button></div>
